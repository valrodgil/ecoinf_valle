...
La hipótesis principal de este proyecto plantea que las codornices con inversión
cromosómica mostrarán diferencias morfológicas significativas según su origen, ya sean del
continente o de los archipiélagos de Canarias y Madeira. Según las predicciones del síndrome
insular y los resultados obtenido por otros estudios, se prevé de forma más concreta: (i) Las codornices procedentes de Madeira y Canarias tenderán a ser de mayor tamaño corporal que las del continente. (ii) Las codornices procedentes de Madeira y Canarias presentarán una colorimetría y un patrón de plumaje mucho más oscuro que las del continente. (iii) Las codornices procedentes de Madeira y Canarias mostrarán una disminución en los niveles de grasa corporal (relacionada con el impulso migrador). (iv) Las codornices de Madeira y Canarias presentarán un aparato de vuelo menos eficiente que las del continente.
...
datos_filtradosBB <- datos |> 
  filter(genotipo == "BB" & euring == 4)

# Solo AB Eu5
datos_filtradosAB <- datos |> 
  filter(genotipo == "AB" & euring == 4)
#Ahora prefiero los euring 4
```
